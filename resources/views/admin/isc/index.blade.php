            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('isc.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="judul_singkat">Judul Singkat</label>
                                <input type="text" id="judul_singkat" class="form-control" name="judul_singkat"
                                    value="{{ $data->isc ? ($data->isc->judul_singkat ? $data->isc->judul_singkat : '') : '' }}">
                                @error('judul_singkat')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="judul_panjang" class="form-control" name="judul_panjang"
                                    value="{{ $data->isc ? ($data->isc->judul_panjang ? $data->isc->judul_panjang : '') : '' }}">
                                @error('judul_panjang')
                                    <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="tema" class="form-control" name="tema"
                                    value="{{ $data->isc ? ($data->isc->tema ? $data->isc->tema : '') : '' }}">
                                @error('tema')
                                    <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi" class="form-control" name="deskripsi"
                                    rows="10">{{ $data->isc ? ($data->isc->deskripsi ? $data->isc->deskripsi : '') : '' }}</textarea>
                                @error('deskripsi')
                                    <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="link_instagram" class="form-control" name="link_instagram"
                                            value="{{ $data->isc ? ($data->isc->link_instagram ? $data->isc->link_instagram : '') : '' }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="link_registrasi" class="form-control"
                                            ...
                                            value="{{ $data->isc ? ($data->isc->link_registrasi ? $data->isc->link_registrasi : '') : '' }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="link_berkas" class="form-control" name="link_berkas"
                                            value="{{ $data->isc ? ($data->isc->link_berkas ? $data->isc->link_berkas : '') : '' }}">
                                        @error('link_berkas')
                                            <small class="text-danger mt-1">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_maskot" class="form-control" name="nama_maskot"
                                    value="{{ $data->isc ? ($data->isc->nama_maskot ? $data->isc->nama_maskot : '') : '' }}">
                                @error('nama_maskot')
                                    <small class="text-danger mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi_maskot" class="form-control" name="deskripsi_maskot"
                                    rows="10">{{ $data->isc ? ($data->isc->deskripsi_maskot ? $data->isc->deskripsi_maskot : '') : '' }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="{{ $data->isc ? ($data->isc->logo ? $data->isc->logo : '') : '' }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="{{ $data->isc ? ($data->isc->maskot ? $data->isc->maskot : '') : '' }}"
                                                class="img-thumbnail w-100" alt="">
                                        </div>
                                        <div class="col-9">
                                            <div class="form-group">

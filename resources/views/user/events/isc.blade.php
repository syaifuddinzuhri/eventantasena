...
@section('content')
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center"
        ...
        <div class="container" data-aos="fade-in">
            <h1>{{ $data->isc->judul_singkat }} - {{ $data->isc->judul_panjang }}</h1>
            <h2>{{ $data->isc->tema }}</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 d-flex justify-content-center align-items-stretch position-relative"
                        data-aos="fade-right">
                        <img src="{{ $data->isc->logo ? $data->isc->logo : asset('assets/img/logo.png') }}"
                            class="w-50" alt="">
                    </div>

                    <div
                        class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                        <h4 data-aos="fade-up">Tentang {{ $data->isc->judul_singkat }}</h4>
                        <h3 data-aos="fade-up">{{ $data->isc->judul_panjang }}</h3>
                        <p data-aos="fade-up">{{ $data->isc->deskripsi }}</p>
                    </div>
                </div>
        ...
        <section class="about">
            <section>
                <div class="container">
                    ...
                    <div class="row">
                        @if ($data->isc->cabangs)
                            @foreach ($data->isc->cabangs as $item)
                                <div
